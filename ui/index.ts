...
function start(period: number): Signal {
	...
	var load = () => {
		mget('/api/v1/current', '/api/v1/hourly?n=48')
...
function renderRow(
	el: HTMLElement,
	fn: (root: El, l: El, r: El) => void) {
	var root = El.of(document.createElement('div'))
		.addClass('row')
		.appendTo(el);

	var l = El.of(document.createElement('div'))
		.addClass('l')
		.appendTo(root.el);

	var r = El.of(document.createElement('div'))
		.addClass('r')
		.appendTo(root.el);
		...
		El.of(document.createElement('div'))
			...
			.do((host) => {
				...
				renderRow(host.el as HTMLElement, (root, l, r) => {
					...
					renderMs(l.el as HTMLElement, report.currently.p50);
					El.create('div')
						.addClass('label')
						.setText('rtt')
						.appendTo(l.el);
				...
				renderRow(host.el as HTMLElement, (root, l, r) => {
					...
					l.addClass('curr');
					formatLossPercent(l.el as HTMLElement, report.currently.lossRatio);
					El.create('div')
						.addClass('label')
						.setText('loss')
						.appendTo(l.el);
